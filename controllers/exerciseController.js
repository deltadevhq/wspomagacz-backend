...
const fetchExercises = async (req, res) => {
  try {
    const { user_id, type: exercise_type, name: exercise_name, offset, limit } = req.query;
    ...
    const exercises = await exerciseModel.selectExercises(user_id, exercise_type, exercise_name, offset, limit);
